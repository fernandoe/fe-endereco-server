...
--
-- Host: localhost    Database: endereco
-- ------------------------------------------------------
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2018-07-10 14:17:27.732974'),(2,'contenttypes','0002_remove_content_type_name','2018-07-10 14:17:27.811527'),(3,'auth','0001_initial','2018-07-10 14:17:28.067128'),(4,'auth','0002_alter_permission_name_max_length','2018-07-10 14:17:28.086585'),(5,'auth','0003_alter_user_email_max_length','2018-07-10 14:17:28.102436'),(6,'auth','0004_alter_user_username_opts','2018-07-10 14:17:28.116304'),(7,'auth','0005_alter_user_last_login_null','2018-07-10 14:17:28.129793'),(8,'auth','0006_require_contenttypes_0002','2018-07-10 14:17:28.134731'),(9,'auth','0007_alter_validators_add_error_messages','2018-07-10 14:17:28.150126'),(10,'auth','0008_alter_user_username_max_length','2018-07-10 14:17:28.164654'),(11,'fe_core','0001_initial','2018-07-10 14:17:28.592104'),(12,'admin','0001_initial','2018-07-10 14:17:28.728977'),(13,'admin','0002_logentry_remove_auto_add','2018-07-10 14:17:28.755343'),(14,'auth','0009_alter_user_last_name_max_length','2018-07-10 14:17:28.776789'),(15,'fe_endereco','0001_initial','2018-07-10 14:17:28.906426'),(16,'sessions','0001_initial','2018-07-10 14:17:28.947145');
...
--
-- Table structure for table `fe_endereco_endereco`
--

DROP TABLE IF EXISTS `fe_endereco_endereco`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fe_endereco_endereco` (
  `uuid` char(32) NOT NULL,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL,
  ...
  PRIMARY KEY (`uuid`),
  KEY `fe_endereco_endereco_entidade_id_ead1bdb9_fk_fe_core_entity_uuid` (`entidade_id`),
  KEY `fe_endereco_endereco_usuario_id_50fe3c09_fk_fe_core_user_uuid` (`usuario_id`),
  CONSTRAINT `fe_endereco_endereco_entidade_id_ead1bdb9_fk_fe_core_entity_uuid` FOREIGN KEY (`entidade_id`) REFERENCES `fe_core_entity` (`uuid`),
  CONSTRAINT `fe_endereco_endereco_usuario_id_50fe3c09_fk_fe_core_user_uuid` FOREIGN KEY (`usuario_id`) REFERENCES `fe_core_user` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fe_endereco_endereco`
--

LOCK TABLES `fe_endereco_endereco` WRITE;
...
-- Dump completed on 2018-07-10 14:40:58
